...
--IMPORTANT--
To play the game, right click 'pirate.ps1' and select 'run with powershell' note that you need to have admin access to run the game.
...
This game does work without the UI, you can just close the second powershell window that opens and everything will run normally (but you won't get music).
